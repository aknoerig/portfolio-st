<?php 
    ...
    $_file_extensions = array('jpg', 'jpeg', 'jpe', 'gif', 'png', 'ogv', 'mp4', 'webm'); 

    // erlaubte Dateiendungen für Audio 
    $_file_extensions_doc = array('pdf'); 

    // erlaubte MIME-Typen für Bilder 
    $_file_mime_types = array('image/pjpeg', 'image/jpeg', 'image/gif', 'image/png', 'image/x-png', 'video/ogg', 'video/mp4', 'video/webm'); 
