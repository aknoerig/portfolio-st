...
?>
	...
	<div id="welcome" class="handheld <?php echo $_set_intro; ?>"><img src="http://www.sabrinatheissen.com/img/loader.gif"><br /><br /><img src="http://www.sabrinatheissen.com/img/welcome.png"></div>
...
<?php
	...
	$sql_rand = "SELECT 
		...
		while($row_rand = mysql_fetch_assoc($result_rand)) {
			...
			echo "<div id=\"intro\" class=\"introCol".$_set_intro."\" style=\"background-image: url('http://www.sabrinatheissen.com/cms/images/".htmlentities($row_rand['content_img'], ENT_QUOTES)."');-webkit-background-image: url('http://www.sabrinatheissen.com/cms/images/".htmlentities($row_rand['content_img'], ENT_QUOTES)."');-moz-background-image: url('http://www.sabrinatheissen.com/cms/images/".htmlentities($row_rand['content_img'], ENT_QUOTES)."');-o-background-image: url('http://www.sabrinatheissen.com/cms/images/".htmlentities($row_rand['content_img'], ENT_QUOTES)."');-ms-background-image: url('http://www.sabrinatheissen.com/cms/images/".htmlentities($row_rand['content_img'], ENT_QUOTES)."');\"></div>";
			
		}
		
?>

	<div id="welcome" class="<?php echo $_set_intro; ?>"><img src="http://www.sabrinatheissen.com/img/welcome.png"></div>
...
if(isset($_GET['cat']) AND $_GET['cat'] == "all") {
	...
	if(!isset($_GET['book'])) {
			...
			echo "<div id=\"opener\"><a href=\"/books/".$pushCat."/".$_GET['book']."/\"><img class=\"o_img\" src=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img['content_img'], ENT_QUOTES)."\" /></a><div id=\"client\"><img src=\"http://www.sabrinatheissen.com/img/No/no_".htmlentities($row_items['recordListingID'], ENT_QUOTES).".svg\" class=\"no\" /><br /><h3>".htmlentities($row_client['name'], ENT_QUOTES)."</h3></div></div>\n";
			echo "";
		...
		if ($detect->isMobile() && !$detect->isTablet()) {
			...
			echo "<img class=\"less-margin\" src=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img['content_img'], ENT_QUOTES)."\" alt=\"Sabrina Theissen | N&deg;".htmlentities($row_title_item['recordListingID'], ENT_QUOTES)." &rsaquo;".htmlentities($row_title_item['name'], ENT_QUOTES)."&lsaquo; for ".htmlentities($row_title_client['name'], ENT_QUOTES)."\" />\n";
...
if($row_pushRank['recordListingID'] == "") {
            echo "<meta http-equiv=\"refresh\" content=\"0; URL=http://www.sabrinatheissen.com/books/\">\n"; 
}
		...
		if($row_client_state['hair'] != $row_client_state['makeup'] AND $row_client_state['setdesign'] != ""){
			...
			echo "<div id=\"client\"><img src=\"http://www.sabrinatheissen.com/img/No/no_".htmlentities($row_pushRank['recordListingID'], ENT_QUOTES).".svg\" class=\"no\" /><br /><h3>".htmlentities($row_client['name'], ENT_QUOTES)."</h3></div></div>\n";
...
if(isset($_GET['cat']) AND $_GET['cat'] == "all") {
	...
	$sql_img = "SELECT 
			...
			echo "<div id=\"project\" class=\"book-item\"><a href=\"/books/".$pushCat."/".$row_items_list['ID']."/\" title=\"&nbsp;&rsaquo;".htmlentities($row_items_list['name'], ENT_QUOTES)."&lsaquo; for ".htmlentities($row_client_list['name'], ENT_QUOTES)."&nbsp;\"><img src=\"http://www.sabrinatheissen.com/cms/images/thumbs/".htmlentities($row_img['content_img'], ENT_QUOTES)."\" alt=\"Sabrina Theissen | N&deg;".htmlentities($row_items_list['recordListingID'], ENT_QUOTES)." &rsaquo;".htmlentities($row_items_list['name'], ENT_QUOTES)."&lsaquo; for ".htmlentities($row_client_list['name'], ENT_QUOTES)."\" /></a>";
			
				if ($detect->isMobile() && !$detect->isTablet()) {

					echo "<img src=\"http://www.sabrinatheissen.com/img/No/no_".htmlentities($row_items_list['recordListingID'], ENT_QUOTES).".svg\" class=\"no\" />";
