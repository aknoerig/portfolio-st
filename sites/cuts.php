...
<div id="content">
	...
	<?php
      ...
      $anzahl_count = mysql_result($result_count, 0); 
	...
	$sql_img = "SELECT 
			...
			echo "<video width=\""; if($sizing[0] > 320) { echo "".($sizing[0]/3.5).""; } else { echo "".$sizing[0].""; } echo "\" height=\""; if($sizing[0] > 320) { echo "".($sizing[1]/3.5).""; } else { echo "".$sizing[1].""; } echo "\" poster=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img['content_img'], ENT_QUOTES)."\" controls=\"controls\" preload=\"none\">\n";
	...
	$sql_img_array = "SELECT 
			...
			while($row_img_array = mysql_fetch_assoc($result_img_array)) {
					...
					if(substr("".htmlentities($row_img_array['content_img'], ENT_QUOTES)."", 20) == "mp4") {
						...
						$setCodec ="codecs=vp8, vorbis";
										...
										if(substr("".htmlentities($row_img_array['content_img'], ENT_QUOTES)."", -3) != "png") {
      									...
      									echo "<source type=\"video/".$setType."; ".$setCodec."\" src=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img_array['content_img'], ENT_QUOTES)."\" width=\""; if($sizing[0] > 320) { echo "".($sizing[0]/3.5).""; } else { echo "".$sizing[0].""; } echo "\" height=\""; if($sizing[0] > 320) { echo "".($sizing[1]/3.5).""; } else { echo "".$sizing[1].""; } echo "\" />\n";			
   		 		...
   		 		echo "</video>\n"; 
         		echo "<a href=\"/cuts/".htmlentities($row_items['ID'], ENT_QUOTES)."/\"><h2>".htmlentities($row_items['caption'], ENT_QUOTES)."</h2></a><p>".$row_items['text']."</p><h3>".htmlentities($row_items['date'], ENT_QUOTES)."</h3>\n";
...
*/
		...
		echo "<div id=\"pages\" style=\"width:"; if($sizing[0] > 299) { echo "".($sizing[0]/$quotient).""; } else { echo "".$sizing[0].""; } echo "px; height:"; if($sizing[0] > 299) { echo "".($sizing[1]/$quotient).""; } else { echo "".$sizing[1].""; } echo "px;\"><h2 class=\"".htmlentities($row_items['pager'], ENT_QUOTES)."\" style=\"width:"; if($sizing[0] > 299) { echo "".($sizing[0]/$quotient).""; } else { echo "".$sizing[0].""; } echo "px; bottom: "; if($sizing[0] > 299) { echo "".((($sizing[1]/$quotient)-60)/2).""; } else { echo "".(($sizing[1]/$quotient)-35).""; } echo "px;\">1/".($row_img_count['COUNT(content_img)']+1)."</h2></div>";
	   		         						echo "<img class=\"sub\" src=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img_array['content_img'], ENT_QUOTES)."\" width=\""; if($sizing[0] > 299) { echo "".($sizing[0]/$quotient).""; } else { echo "".$sizing[0].""; } echo "\" height=\""; if($sizing[0] > 299) { echo "".($sizing[1]/$quotient).""; } else { echo "".$sizing[1].""; } echo "\" alt=\"Sabrina Theissen | &rsaquo;".htmlentities($row_items['caption'], ENT_QUOTES)."&lsaquo; ".$postTxt."\" />\n";
   		         
   		      		}
   		      		
   		      		   		         		echo "<img class=\"last-tear\" src=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img_single['content_img'], ENT_QUOTES)."\" width=\""; if($sizing[0] > 299) { echo "".($sizing[0]/$quotient).""; } else { echo "".$sizing[0].""; } echo "\" height=\""; if($sizing[0] > 299) { echo "".($sizing[1]/$quotient).""; } else { echo "".$sizing[1].""; } echo "\" alt=\"Sabrina Theissen | &rsaquo;".htmlentities($row_items['caption'], ENT_QUOTES)."&lsaquo; ".$postTxt."\" />\n";
	...
	<?php
			...
			if(isset($_GET['cat']) AND ($_GET['cat']) == 0 ) {
					...
					if(isset($_GET['book']) AND ($_GET['book']+8) <= $anzahl_count) {
...
<div id="content">
	...
	$sql_img = "SELECT 
			...
			echo "<video width=\"".$sizing[0]."\" height=\"".$sizing[1]."\" poster=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img['content_img'], ENT_QUOTES)."\" controls=\"controls\" preload=\"none\">\n";
					...
					if(substr("".htmlentities($row_img_array['content_img'], ENT_QUOTES)."", 20) == "mp4") {
						...
						$setCodec ="codecs=vp8, vorbis";
										...
										if(substr("".htmlentities($row_img_array['content_img'], ENT_QUOTES)."", -3) != "png") {
      									...
      									echo "<source type=\"video/".$setType."; ".$setCodec."\" src=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img_array['content_img'], ENT_QUOTES)."\" width=\"".$sizing[0]."\" height=\"".$sizing[1]."\" />\n";			
...
*/
		...
		echo "<div id=\"pages\" style=\"width:".$sizing[0]."px; height:".$sizing[1]."px;\"><h2 class=\"".htmlentities($row_items['pager'], ENT_QUOTES)."\" style=\"width:".$sizing[0]."px; bottom: ".(($sizing[1]/2)-35)."px;\">1/".($row_img_count['COUNT(content_img)']+1)."</h2></div>";
	   		         						...
	   		         						echo "<img class=\"sub\" src=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img_array['content_img'], ENT_QUOTES)."\" width=\"".$sizing[0]."\" height=\"".$sizing[1]."\" alt=\"Sabrina Theissen | &rsaquo;".htmlentities($row_items['caption'], ENT_QUOTES)."&lsaquo; ".$postTxt."\" />\n";
   		         
   		      		}
   		      		
   		      		   		         		echo "<img class=\"last-tear\" src=\"http://www.sabrinatheissen.com/cms/images/".htmlentities($row_img_single['content_img'], ENT_QUOTES)."\" width=\"".$sizing[0]."\" height=\"".$sizing[1]."\" alt=\"Sabrina Theissen | &rsaquo;".htmlentities($row_items['caption'], ENT_QUOTES)."&lsaquo; ".$postTxt."\" />\n";
