...
<script>
	...
	$(document).ready(function() {
		...
		<h3 class="second">Set Up Account</h3>
			...
			<div class="first">
				<form action="" method="post" accept-charset="ISO-8859-1">
					<input type="text" name="access" id="access" class="ltrm_inpt" value="Type in your key" onfocus="this.value=''" /><br />
					<input type="button" name="submit" id="submit" value="Enter" onclick="accessltrm()" class="reg_btn"/>
				</form>
			</div>
			<div class="second">
				<form action="" method="post" accept-charset="ISO-8859-1">
					<input type="text" name="name" id="name" class="ltrm_inpt" value="Your name" onfocus="this.value=''" /><br />
					<input type="text" name="agency" id="agency" class="ltrm_inpt" value="Magazine or agency" onfocus="this.value=''" /><br />
					<input type="text" name="mail" id="mail" class="ltrm_inpt" value="Your email address" onfocus="this.value=''" /><br />
		...
		<p class="default create do first">( <span>Set up account</span> )</p>
